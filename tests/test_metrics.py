...
class TestMetricsEndpoint:
    ...
    def test_streaming_chat_records_ttft_and_stream_metrics(
        ...
        # Streaming token counts require deep generator integration;
        # HTTP-level request/latency/TTFT metrics are sufficient for Phase 1.
        assert (
            'vllm_mlx_http_requests_total{method="POST",path="/v1/chat/completions",status_code="200"} 1.0'
            in scrape.text
        )
