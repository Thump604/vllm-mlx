...
@pytest.mark.parametrize("fixture_name", ["qwen3-5-hybrid.json", "laguna-s-2-1.json"])
def test_hybrid_adapters_reject_irrelevant_dense_kv_profile(fixture_name: str):
    result = adapt_model_config(_config(fixture_name), kv_profile=_profile())
